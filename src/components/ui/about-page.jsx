...
export default function AboutPage() {
  return (
    <div className="flex flex-col overflow-hidden relative bg-[#08090A] text-white min-h-screen">
        ...
        <div className="mx-auto max-w-4xl space-y-8 px-6 text-center">
          <div className="space-y-6">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight">
              The <span className="text-[#888]">DevMap</span>
              <br />
              Ecosystem
            </h1>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="rounded-full border-[rgba(255,255,255,0.12)] text-white hover:bg-[rgba(255,255,255,0.06)] hover:text-white"
              >
      ...
      {/* ---------------- ABOUT SECTION ---------------- */}
      <section className="py-20 md:py-28 bg-[#111213]/30 border-t border-[rgba(255,255,255,0.06)] relative z-10">
        <div className="mx-auto max-w-6xl space-y-16 px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
            ...
            <motion.div
              ...
              className="flex flex-col overflow-hidden rounded-2xl bg-[#111213]/40 backdrop-blur-sm border border-[rgba(255,255,255,0.06)] hover:border-[#555] transition-all p-8"
            >
              <div className="mb-6 h-12 w-12 rounded-xl bg-[rgba(255,255,255,0.06)] border border-[rgba(255,255,255,0.12)] flex items-center justify-center">
                <TrendingUp className="w-5 h-5 text-white" />
              </div>
              <h3 className="text-2xl font-bold mb-4 text-white">
                Accelerate Growth
              </h3>
              <p className="text-[#888] mb-6 leading-relaxed flex-1">
              ...
              <Button
                variant="secondary"
                className="mt-auto w-full md:w-auto bg-[rgba(255,255,255,0.06)] text-white hover:bg-[rgba(255,255,255,0.12)] border-0"
              >
            ...
            >
              ...
              <Button
                variant="outline"
                className="mt-auto w-full md:w-auto border-[rgba(255,255,255,0.12)] text-white hover:bg-[rgba(255,255,255,0.06)] hover:text-white"
                asChild
              >
